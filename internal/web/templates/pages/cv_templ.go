...
func CVPage() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("\" target=\"_blank\" download=\"janos_molnar_CV.pdf\" class=\"shadow-xl float-left inline-flex items-start justify-content px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800\">download cv</a></div><!-- contacts button --><div class=\"mt-6 flex flex-wrap gap-4 justify-center\"><a href=\"#\" hx-get=\"/contact\" hx-target=\"#page-content\" hx-push-url=\"true\" class=\"shadow-xl float-left inline-flex items-start justify-content px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800\">contact me</a></div></div><hr class=\"my-6 border-t border-gray-300\"><div class=\"flex flex-col text-left mb-8\"><span class=\"text-gray-700 uppercase font-bold tracking-wider mb-2\">programming skills</span><ul><li class=\"mb-0\">Python(5+ years)</li><li class=\"mb-0\">Django, FastAPI, etc</li><li class=\"mb-0\">Go</li><li class=\"mb-0\">Frontent(JS, TS)</li><li class=\"mb-0\">SQL</li></ul></div><div class=\"flex flex-col text-left\"><span class=\"text-gray-700 uppercase font-bold tracking-wider mb-2\">ops skills</span><ul><li class=\"mb-0\">AWS / GCP</li><li class=\"mb-0\">Kubernetes / Helm</li><li class=\"mb-0\">Prometheus</li><li class=\"mb-0\">Terraform</li><li class=\"mb-0\">Bash / Linux</li></ul></div></div></div><div class=\"col-span-4 sm:col-span-9\"><div class=\"bg-white shadow-xl rounded-lg p-6\"><h2 class=\"text-xl font-bold mt-6 mb-4\">curriculum vitae</h2><div class=\"mb-6\"><div class=\"flex justify-between flex-wrap gap-2 w-full\"><span class=\"text-blue-700 font-bold\">senior backend engineer</span><p><span>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
